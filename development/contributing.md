...
Use the GitHub [issue tracker](https://github.com/Simple-Robotics/proxsuite/issues) to report bugs or suggest features.
...
Ask questions in the [discussions section](https://github.com/Simple-Robotics/proxsuite/discussions).
