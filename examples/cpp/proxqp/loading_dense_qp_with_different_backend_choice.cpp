...
main()
{
  ...
  proxqp::dense::QP<T> qp(dim, n_eq, n_in, true, DenseBackend::PrimalDualLDLT);
  ...
  proxqp::dense::QP<T> qp2(dim, n_eq, 0, true, DenseBackend::PrimalLDLT);
  // true specifies we take into accounts box constraints
  ...
  // backend choice.
  proxqp::dense::QP<T> qp3(dim, n_eq, 0, true, DenseBackend::Automatic);
