#include <iostream>
#include <proxsuite/osqp/dense/dense.hpp> // load the dense solver backend
...
main()
{
  ...
  osqp::dense::QP<T> qp(dim, n_eq, n_in); // create the QP object
  qp.init(qp_random.H,
          qp_random.g,
          qp_random.A,
          qp_random.b,
  ...
  osqp::dense::QP<T> qp_box(dim, n_eq, n_in, true); // create the QP object
