...
#else
#define VEG_DECLVAL(...) (::proxsuite::linalg::veg::_detail::_meta::declval<__VA_ARGS__>())
#endif
...
#define VEG_ALL_OF(...)                                                        \
	::proxsuite::linalg::veg::meta::and_test<                                                       \
			::proxsuite::linalg::veg::meta::make_index_sequence<                                        \
					::proxsuite::linalg::veg::meta::pack_size<decltype((void)(__VA_ARGS__))...>::value>,    \
...
#define __VEG_IMPL_DEF_CONCEPT(Tpl, Name, Value, ...)                          \
	...
	namespace {                                                                  \
	template <__VEG_PP_REMOVE_PAREN1(Tpl)>                                       \
	constexpr bool const& Name = ::proxsuite::linalg::veg::meta::bool_constant<Value>::value;       \
	}                                                                            \
	VEG_NOM_SEMICOLON
#else
#define __VEG_IMPL_DEF_CONCEPT(Tpl, Name, Value, ...)                          \
...
#define VEG_CONCEPT_EXPR(Tpl, TplNames, Name, Expr, ...)                       \
	...
	struct test_sfinae_##Name<                                                   \
		...
		using TestExpr = ::proxsuite::linalg::veg::meta::bool_constant<__VA_ARGS__>;                  \
...
#define VEG_DEF_CONCEPT(Tpl, Name, ...)                                        \
	__VEG_IMPL_DEF_CONCEPT(                                                      \
			Tpl, Name, (__VA_ARGS__), ::proxsuite::linalg::veg::meta::bool_constant<__VA_ARGS__>);      \
	VEG_TEMPLATE(                                                                \
...
#define __VEG_IMPL_OVERLOAD(Name_Tpl, Param)                                   \
	template <                                                                   \
			...
			typename ::proxsuite::linalg::veg::_detail::_meta::enable_if<__VEG_PP_UNWRAP Param, int>::  \
					type = 0>                                                            \
	auto __VEG_PP_CAT(                                                           \
			check_, __VEG_PP_HEAD Name_Tpl)() noexcept->::proxsuite::linalg::veg::meta::true_type;
...
#define __VEG_IMPL_TEMPLATE2_HELPER_1(Constraint, Param)                       \
	::proxsuite::linalg::veg::meta::enable_if_t<(Constraint), __VEG_PP_TAIL Param> __VEG_PP_HEAD    \
			Param
...
#define VEG_INLINE_VAR(Name, Obj)                                              \
	inline constexpr auto const& Name = ::proxsuite::linalg::veg::meta::static_const<Obj>::value;   \
...
#define VEG_INLINE_VAR(Name, Obj)                                              \
	namespace /* NOLINT */ {                                                     \
	constexpr auto const& Name = ::proxsuite::linalg::veg::meta::static_const<Obj>::value;          \
	}                                                                            \
	static_assert((void(Name), true), ".")
...
#define VEG_INLINE_VAR_TEMPLATE(Tpl, Name, ...) /* NOLINT */                   \
	...
	constexpr auto const& Name =                       /* NOLINT */              \
			::proxsuite::linalg::veg::meta::static_const<__VA_ARGS__>::value; /* NOLINT */              \
	}                                                                            \
	VEG_NOM_SEMICOLON /* NOLINT */
#else
...
constexpr auto operator""__veglib_const_literal_gnuc() noexcept // NOLINT
		-> proxsuite::linalg::veg::StrLiteralConstant<proxsuite::linalg::veg::CharUnit(Cs)...> {
	return {};
}
...
#define __VEG_IMPL_UTF8_CONST(Literal)                                         \
	(::proxsuite::linalg::veg::_detail::extract_chars_expr([]() /* NOLINT */ noexcept {             \
		struct __VEG_PP_CAT(_veglib_type, __LINE__) {                              \
			static constexpr auto value() noexcept -> decltype(Literal) {            \
				return Literal;                                                        \
			}                                                                        \
			using Size = ::proxsuite::linalg::veg::meta::                                               \
					constant<::proxsuite::linalg::veg::usize, sizeof(value()) / sizeof(value()[0]) - 1>;    \
		};                                                                         \
...
#define __VEG_IMPL_STRUCT_SETUP(PClass, ...) /* NOLINT */                      \
	...
	struct _veglib_impl_member_extract {                                         \
		...
		using MemberTuple = decltype(::proxsuite::linalg::veg::_detail::make_simple_tuple(            \
		...
		static constexpr auto member_pointers() noexcept -> MemberTuple {          \
			return ::proxsuite::linalg::veg::_detail::make_simple_tuple(::proxsuite::linalg::veg::_detail::Empty {         \
		...
		static constexpr auto class_name_len() noexcept -> ::proxsuite::linalg::veg::usize {          \
		...
		static constexpr auto member_name_lens() noexcept -> ::proxsuite::linalg::veg::_detail::      \
				Array_<::proxsuite::linalg::veg::usize, __VEG_PP_TUPLE_SIZE((__VA_ARGS__))> {             \
			return {{__VEG_PP_TUPLE_FOR_EACH(                                        \
					__VEG_IMPL_GET_MEMBER_NAME_LEN, _, (__VA_ARGS__))}};                 \
		}                                                                          \
	};                                                                           \
	friend struct ::proxsuite::linalg::veg::_detail::member_extract_access<__VEG_PP_REMOVE_PAREN(   \
			PClass)>;                                                                \
	VEG_NOM_SEMICOLON
