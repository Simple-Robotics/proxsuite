...
#define __VEG_IMPL_BIND(I, Tuple, Identifier) /* NOLINT */                     \
	auto&& Identifier /* NOLINT */ = ::proxsuite::linalg::veg::nb::get<I>{}(VEG_FWD(Tuple));
...
#define __VEG_IMPL_BIND_ID_SEQ(/* NOLINT */                                    \
	...
	static_assert(                                                               \
			::std::tuple_size<                                                       \
					typename ::proxsuite::linalg::veg::meta::uncvref_t<decltype(TupleId)>>::value ==        \
					(Tuple_Size),                                                        \
...
struct tuplify {
	...
	operator()(Ts... args) const VEG_NOEXCEPT->proxsuite::linalg::veg::Tuple<Ts...> {
...
#define __VEG_IMPL_LEAF(Tuple, I, ...) /* NOLINT */                            \
	(static_cast<::proxsuite::linalg::veg::tuple::TupleLeaf<I, __VA_ARGS__> const&>((Tuple).inner)  \
	     .leaf)
#define __VEG_IMPL_LEAF_MUT(Tuple, I, ...) /* NOLINT */                        \
	(static_cast<::proxsuite::linalg::veg::tuple::TupleLeaf<I, __VA_ARGS__>&>((Tuple).inner).leaf)
#define __VEG_IMPL_LEAF_ONCE(Tuple, I, ...) /* NOLINT */                       \
	(static_cast<__VA_ARGS__&&>(                                                 \
			static_cast<::proxsuite::linalg::veg::tuple::TupleLeaf<I, __VA_ARGS__>&&>((Tuple).inner)    \
					.leaf))
...
#define __VEG_IMPL_LEAF(Tuple, I, ...) /* NOLINT */                            \
	(static_cast<__VA_ARGS__ const&>(                                            \
			static_cast<::proxsuite::linalg::veg::tuple::TupleLeaf<I, __VA_ARGS__> const&>(             \
					(Tuple).inner)                                                       \
					.leaf_get()))
...
struct unpack {
	VEG_TEMPLATE(
			...
			requires(VEG_CONCEPT(
					fn_once<Fn, proxsuite::linalg::veg::meta::invoke_result_t<Fn, Ts&&...>, Ts&&...>)),
...
struct map_i {
	...
	const VEG_NOEXCEPT_IF(
			VEG_ALL_OF(VEG_CONCEPT(nothrow_fn_once< //
														 ...
														 proxsuite::linalg::veg::meta::invoke_result_t<inner_ith<Fn&, Is>, Ts>,
														 Ts>)))
			->Tuple<proxsuite::linalg::veg::meta::invoke_result_t<inner_ith<Fn&, Is>, Ts>...> {
		return {
				inplace[tuplify{}],
...
struct map {
	VEG_TEMPLATE(
			...
			requires(VEG_ALL_OF(VEG_CONCEPT(
					fn_mut<Fn, proxsuite::linalg::veg::meta::invoke_result_t<Fn&, Ts&&>, Ts&&>))),
			VEG_NODISCARD VEG_INLINE VEG_CPP14(constexpr) auto
			operator(),
			(args, IndexedTuple<proxsuite::linalg::veg::meta::index_sequence<Is...>, Ts...>&&),
			(fn, Fn))
	const VEG_NOEXCEPT_IF(
			VEG_ALL_OF(VEG_CONCEPT(
					nothrow_fn_mut<Fn, proxsuite::linalg::veg::meta::invoke_result_t<Fn&, Ts&&>, Ts&&>)))
...
struct TupleBaseInfoImpl {
	...
	using IndexedTuple =
			proxsuite::linalg::veg::tuple::IndexedTuple<meta::make_index_sequence<sizeof...(Ts)>, Ts...>;
};
...
template <typename T>
using is_tuple = proxsuite::linalg::veg::meta::bool_constant<TupleBaseInfo<T>::is_tuple>;
template <typename T>
using tuple_size = proxsuite::linalg::veg::meta::constant<usize, TupleBaseInfo<T>::size>;
...
namespace concepts {
namespace tuple {
VEG_DEF_CONCEPT(typename T, tuple, proxsuite::linalg::veg::tuple::meta::is_tuple<T>::value);
} // namespace tuple
} // namespace concepts
...
VEG_NODISCARD VEG_INLINE constexpr auto
get(tuple::IndexedTuple<proxsuite::linalg::veg::meta::index_sequence<Is...>, Ts...> const& tup)
		VEG_NOEXCEPT->ith<I, Ts...> const& {
	return __VEG_IMPL_LEAF(tup, I, ith<I, Ts...>);
}
template <usize I, usize... Is, typename... Ts>
VEG_NODISCARD VEG_INLINE constexpr auto
get(tuple::IndexedTuple<proxsuite::linalg::veg::meta::index_sequence<Is...>, Ts...>& tup)
...
struct with {
	VEG_TEMPLATE(
			typename... Fns,
			requires(VEG_ALL_OF(
					VEG_CONCEPT(fn_once<Fns, proxsuite::linalg::veg::meta::invoke_result_t<Fns>>))),
			VEG_NODISCARD VEG_INLINE constexpr auto
			operator(),
			(... args, Fns))
	const VEG_NOEXCEPT_IF(
			VEG_ALL_OF(
					VEG_CONCEPT(nothrow_fn_once<Fns, proxsuite::linalg::veg::meta::invoke_result_t<Fns>>)))
			->proxsuite::linalg::veg::Tuple<proxsuite::linalg::veg::meta::invoke_result_t<Fns>...> {
...
struct zip {
	...
	using PreZip = proxsuite::linalg::veg::meta::type_sequence_zip<Tuple, Tuples...>;
...
private:
	template <typename... Tuples>
	VEG_INLINE static constexpr auto
	pre_apply(proxsuite::linalg::veg::meta::true_type /*unused*/, Tuples&&... tups)
			VEG_NOEXCEPT->Zip<Tuples...> {
		return zip::apply(VEG_FWD(tups)...);
	}
	template <typename... Tuples>
	VEG_INLINE static constexpr auto
	pre_apply(proxsuite::linalg::veg::meta::false_type /*unused*/, Tuples&&... tups)
			VEG_NOEXCEPT->Zip<Tuples...> {
	...
	struct Helper {
		...
		template <typename... Ts>
		VEG_INLINE constexpr auto
		apply(Ts&&... tups) const VEG_NOEXCEPT->Type<Ts...> {
			return {
					tuplify{},
					VEG_FWD(first),
	...
	VEG_INLINE static constexpr auto apply(
			IndexedTuple<proxsuite::linalg::veg::meta::index_sequence<Is...>, Ts...> first,
	...
	struct ConverterImpl<proxsuite::linalg::veg::meta::index_sequence<Is...>, InnerTargets...> {
		IndexedTuple<proxsuite::linalg::veg::meta::index_sequence<Is...>, InnerTargets&&...>&& refs;
	...
	struct Converter<Tuple<InnerTargets...>> {
		using Type = ConverterImpl<
				proxsuite::linalg::veg::meta::make_index_sequence<sizeof...(InnerTargets)>,
				InnerTargets...>;
	};
	...
	VEG_INLINE static constexpr auto from_ref_to_result(
			...
			IndexedTuple<proxsuite::linalg::veg::meta::index_sequence<Is...>, Tups...> zipped_refs)
...
struct cat {
	...
	template <typename... Tuples>
	using PreConcat = proxsuite::linalg::veg::meta::type_sequence_cat<Tuple, Tuples...>;
	template <typename... Tuples>
...
private:
	...
	VEG_INLINE static constexpr auto from_ref_to_result(
			...
			IndexedTuple<proxsuite::linalg::veg::meta::index_sequence<Is...>, Refs...> refs)
			VEG_NOEXCEPT->proxsuite::linalg::veg::Tuple<Targets...> {
		return {
				inplace[tuplify{}],
	...
	VEG_INLINE static constexpr auto apply2(
			IndexedTuple<proxsuite::linalg::veg::meta::index_sequence<Is...>, Ts...>&& first,
			IndexedTuple<proxsuite::linalg::veg::meta::index_sequence<Js...>, Us...>&& second)
...
struct deref_assign {
	VEG_TEMPLATE(
			...
			VEG_INLINE VEG_CPP14(constexpr) void
			operator(),
			(ts, IndexedTuple<proxsuite::linalg::veg::meta::index_sequence<Is...>, RefMut<Ts>...>),
			(us, IndexedTuple<proxsuite::linalg::veg::meta::index_sequence<Is...>, Ref<Us>...>))
	const VEG_NOEXCEPT_IF(
...
struct std::tuple_size<proxsuite::linalg::veg::Tuple<Ts...>>
		: ::proxsuite::linalg::veg::meta::constant<proxsuite::linalg::veg::usize, sizeof...(Ts)> {};
