			...
			auto primal_dual_newton_semi_smooth = [&]() -> void {
				for (isize iter_inner = 0; iter_inner < settings.max_iter_in;
					...
					// primal_dual_semi_smooth_newton_step
					{
						...
						ldl_solve_in_place(
								{proxqp::from_eigen, rhs},
								{proxqp::from_eigen, dw_prev},// todo: MAJ dw_prev avec dw pour avoir meilleur guess sur les solve in place
								results,
								data,
								n_tot,
								ldl,
					...
					*/
					...
					bool is_primal_infeasible = proxsuite::proxqp::sparse::detail::global_primal_residual_infeasibility(
							...
							settings,
							precond);
					bool is_dual_infeasible = proxsuite::proxqp::sparse::detail::global_dual_residual_infeasibility(
