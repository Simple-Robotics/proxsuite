...
struct Workspace {
	...
	void setup_symbolic_factorizaton(
			...
			proxsuite::linalg::sparse::SymbolicMatRef<I> H,proxsuite::linalg::sparse::SymbolicMatRef<I> AT,proxsuite::linalg::sparse::SymbolicMatRef<I> CT
			){
...
::proxsuite::linalg::veg::dynstack::StackReq::or_(::proxsuite::linalg::veg::init_list(__VA_ARGS__))
		...
		auto primal_dual_newton_semi_smooth_req = PROX_QP_ALL_OF({
				...
				PROX_QP_ANY_OF({
						...
						PROX_QP_ALL_OF({
								SR::with_len(proxsuite::linalg::veg::Tag<bool>{}, n_in), // active_set_lo
								SR::with_len(proxsuite::linalg::veg::Tag<bool>{}, n_in), // active_set_up
								SR::with_len(
										proxsuite::linalg::veg::Tag<bool>{}, n_in), // new_active_constraints
								(do_ldlt && n_in > 0)
										? PROX_QP_ANY_OF({
		...
		auto req = //
				PROX_QP_ALL_OF({
						...
						x_vec(n_in),                          // l_scaled
						x_vec(n_in),                          // u_scaled
						SR::with_len(proxsuite::linalg::veg::Tag<bool>{}, n_in), // active constr
		...
		/*
			...
			proxsuite::linalg::veg::unsafe:  precises that the function has undefined behavior if upper condition is not respected.
		*/
