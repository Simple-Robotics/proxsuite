...
inline auto
from_eigen(SparseMat<c_float>& mat) -> ladel_sparse_matrix
{
...
inline auto
from_eigen_sym(SparseMat<c_float>& mat) -> ladel_sparse_matrix
{
...
inline auto
solve_eq_qpalm_sparse(VectorViewMut<c_float> x,
