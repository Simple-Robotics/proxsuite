...
inline auto
from_eigen(SparseMat<c_float>& mat) -> csc
{
  return {
    mat.nonZeros(),      mat.rows(),     mat.cols(), mat.outerIndexPtr(),
    mat.innerIndexPtr(), mat.valuePtr(), -1,
  };
}

inline auto
solve_eq_osqp_sparse(VectorViewMut<c_float> x,
