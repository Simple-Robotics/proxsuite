...
DOCTEST_TEST_CASE("sparse random strongly convex unconstrained qp and increasing dimension") {

	std::cout << "---testing sparse random strongly convex qp with increasing dimension---" << std::endl;
...
DOCTEST_TEST_CASE("sparse random not strongly convex unconstrained qp and increasing dimension") {

	std::cout << "---testing sparse random not strongly convex unconstrained qp with increasing dimension---" << std::endl;
	double  sparsity_factor = 0.15;
	T eps_abs = T(1e-9);
	for (isize dim = 10; dim < 1000; dim+=100) {
        ...
        qp.g = - qp.H * x_sol ; // to be dually feasible g must be in the image space of H
