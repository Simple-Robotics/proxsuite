...
DOCTEST_TEST_CASE("sparse random strongly convex qp with equality and inequality constraints and increasing dimension using wrapper API") {

	std::cout << "---testing sparse random strongly convex qp with equality and inequality constraints and increasing dimension using wrapper API---" << std::endl;
	double  sparsity_factor = 0.15;
	T eps_abs = T(1e-9);
	ldlt_test::rand::set_seed(1);
	for (qp::isize dim = 10; dim < 1000; dim+=100) {
...
DOCTEST_TEST_CASE("sparse random strongly convex qp with box inequality constraints and increasing dimension using the API") {

	std::cout << "---testing sparse random strongly convex qp with box inequality constraints and increasing dimension using the API---" << std::endl;
	double  sparsity_factor = 0.15;
	T eps_abs = T(1e-9);
	ldlt_test::rand::set_seed(1);
	for (qp::isize dim = 10; dim < 1000; dim+=100) {
...
DOCTEST_TEST_CASE("sparse random not strongly convex qp with inequality constraints and increasing dimension using the API") {

	std::cout << "---testing sparse random not strongly convex qp with inequality constraints and increasing dimension using the API---" << std::endl;
	double  sparsity_factor = 0.15;
	T eps_abs = T(1e-9);
	T strong_convexity_factor(0.);
	ldlt_test::rand::set_seed(1);
...
DOCTEST_TEST_CASE("sparse random strongly convex qp with degenerate inequality constraints and increasing dimension using the API") {

	std::cout << "---testing sparse random strongly convex qp with degenerate inequality constraints and increasing dimension using the API---" << std::endl;
	double  sparsity_factor = 0.15;
	T eps_abs = T(1e-9);
	T strong_convexity_factor(1e-2);
	ldlt_test::rand::set_seed(1);
...
DOCTEST_TEST_CASE("linear problem with equality inequality constraints and increasing dimension using the API") {
	srand (1);
	std::cout << "---testing linear problem with inequality constraints and increasing dimension using the API---" << std::endl;
	double  sparsity_factor = 0.15;
	T eps_abs = T(1e-9);
	T strong_convexity_factor(0.);
	ldlt_test::rand::set_seed(1);
