                  ...
                  "inequality constraints: test dense init")
{
  ...
  Qp.settings.eps_abs = eps_abs;
  Qp.settings.eps_rel = 0;
  Qp.init(Eigen::Matrix<T,
                        Eigen::Dynamic,
                        Eigen::Dynamic,
                        to_eigen_layout(proxsuite::proxqp::rowmajor)>(qp.H),
          qp.g,
          Eigen::Matrix<T,
                        Eigen::Dynamic,
                        Eigen::Dynamic,
                        to_eigen_layout(proxsuite::proxqp::rowmajor)>(qp.A),
          qp.b,
          Eigen::Matrix<T,
                        Eigen::Dynamic,
                        Eigen::Dynamic,
                        to_eigen_layout(proxsuite::proxqp::rowmajor)>(qp.C),
          qp.u,
          qp.l);
  Qp.solve();
