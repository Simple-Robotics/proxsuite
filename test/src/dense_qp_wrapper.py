...
class SparseQpWrapper(unittest.TestCase):
    ...
    def test_case_update_rho(self):
        print("------------------------sparse random strongly convex qp with equality and inequality constraints: test update rho")
        n = 10
        ...
        Qp.init(H=H,g=np.asfortranarray(g),A=A,b=np.asfortranarray(b),C=C,u=np.asfortranarray(u),l=np.asfortranarray(l),rho = 1.e-7)
        Qp.solve()
    ...
    def test_case_update_mu(self):
        ...
        print("------------------------sparse random strongly convex qp with equality and inequality constraints: test update mus")
    ...
    def test_case_no_equilibration_at_initialization(self):
        ...
        print("------------------------sparse random strongly convex qp with equality and inequality constraints: test with no equilibration at initialization")
    ...
    def test_case_with_equilibration_at_initialization(self):
        ...
        print("------------------------sparse random strongly convex qp with equality and inequality constraints: test with equilibration at initialization")
    ...
    def test_case_no_initial_guess(self):
        ...
        print("------------------------sparse random strongly convex qp with equality and inequality constraints: test with no initial guess")
    ...
    def test_case_no_initial_guess_and_update(self):
        ...
        g = np.random.randn(n)
        H *= 2. # too keep same sparsity structure
        Qp.update(
                H,
                np.asfortranarray(g),
                A,
    ...
    def test_case_warm_starting(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test with warm start---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_warm_start_with_previous_result(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test with warm start with previous result---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
        ...
        Qp.settings.eps_abs = 1.E-9
        Qp.settings.verbose = False
        Qp.settings.initial_guess = proxsuite.qp.InitialGuess.EQUALITY_CONSTRAINED_INITIAL_GUESS
        Qp.init(
                H,
                np.asfortranarray(g),
                A,
        ...
        Qp.solve()
        dua_res = normInf(H @ Qp.results.x + g + A.transpose() @ Qp.results.y + C.transpose() @ Qp.results.z) 
        pri_res = max( normInf(A @ Qp.results.x - b),normInf(np.maximum(C @ Qp.results.x - u,0) + np.minimum(C @ Qp.results.x - l,0)))
        assert(pri_res <= 1E-9)
        assert(dua_res <= 1E-9)
        print("--n = {} ; n_eq = {} ; n_in = {}".format(n,n_eq,n_in))
        print("dual residual = {} ; primal residual = {}".format(dua_res,pri_res))
        ...
        pri_res = max( normInf(A @ Qp.results.x - b),
			normInf(np.maximum(C @ Qp.results.x - u,0) + np.minimum(C @ Qp.results.x - l,0)))
        print("--n = {} ; n_eq = {} ; n_in = {} after warm starting with Qp".format(n,n_eq,n_in))
        print("dual residual = {} ; primal residual = {}".format(dua_res,pri_res))
        print("total number of iteration: {}".format(Qp.results.info.iter))
        print("setup timing = {} ; solve time = {}".format(Qp.results.info.setup_time, Qp.results.info.solve_time))
        ...
        assert(pri_res <= 1.E-9)
        assert(dua_res <= 1.E-9)
        print("--n = {} ; n_eq = {} ; n_in = {} after warm starting with Qp2".format(n,n_eq,n_in))
        print("dual residual = {} ; primal residual = {}".format(dua_res,pri_res))
        print("total number of iteration: {}".format(Qp.results.info.iter))
        print("setup timing = {} ; solve time = {}".format(Qp.results.info.setup_time, Qp.results.info.solve_time))
    ...
    def test_case_cold_start_with_previous_result(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test with cold start with previous result---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
        ...
        Qp.settings.initial_guess = proxsuite.qp.InitialGuess.COLD_START_WITH_PREVIOUS_RESULT
        Qp.solve()
        dua_res = normInf(H @ Qp.results.x + g + A.transpose() @ Qp.results.y + C.transpose() @ Qp.results.z) 
        pri_res = max( normInf(A @ Qp.results.x - b),
			normInf(np.maximum(C @ Qp.results.x - u,0) + np.minimum(C @ Qp.results.x - l,0)))
    ...
    def test_case_equilibration_option(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test equilibration option---")
    ...
    def test_case_equilibration_option_at_update(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test equilibration option at update---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
        ...
        assert(pri_res <= 1.E-9)
        assert(dua_res <= 1.E-9)
        print("--n = {} ; n_eq = {} ; n_in = {} with Qp after update".format(n,n_eq,n_in))
        print("dual residual = {} ; primal residual = {}".format(dua_res,pri_res))
        print("total number of iteration: {}".format(Qp.results.info.iter))
        print("setup timing = {} ; solve time = {}".format(Qp.results.info.setup_time, Qp.results.info.solve_time))
        ...
        assert(pri_res <= 1.E-9)
        assert(dua_res <= 1.E-9)
        print("--n = {} ; n_eq = {} ; n_in = {} with Qp2 after update".format(n,n_eq,n_in))
        print("dual residual = {} ; primal residual = {}".format(dua_res,pri_res))
        print("total number of iteration: {}".format(Qp.results.info.iter))
        print("setup timing = {} ; solve time = {}".format(Qp.results.info.setup_time, Qp.results.info.solve_time))
    ...
    def test_case_warm_start_with_other_initialization(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test warm start with other initialization---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_multiple_solve_with_no_initial_guess(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test multiple solve with no inital guess---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_multiple_solve_with_equality_constrained_initial_guess(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test multiple solve with equality constrained initial guess---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_warm_start_with_previous_result_starting_with_equality_constraints_initial_guess(self):
        
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test multiple solve after warm starting with previous results and equality constrained inital guess---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_warm_start_with_previous_result_starting_with_no_initial_guess(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test multiple solve after warm starting with previous results and no initial guess---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_cold_start_with_previous_result_starting_with_no_initial_guess(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test multiple solve after cold starting with previous results and no initial guess---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_warm_start_with_no_initial_guess(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test multiple solve from warm start and no initial guess---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_warm_start_with_no_initial_guess_and_different_init(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test solve from warm start and no initial guess with other initialization---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_multiple_solve_with_no_initial_guess_and_update(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test multiple solve with no inital guess and update---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_multiple_solve_with_equality_constrained_initial_guess_and_update(self):

        print("---testing sparse random strongly convex qp with equality and inequality constraints: test multiple solve with equality constrained initial guess and update---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_warm_start_with_previous_result_starting_with_equality_constraints_initial_guess_and_update(self):
        
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test multiple solve after warm starting with previous results and equality constrained inital guess and update---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_warm_start_with_previous_result_starting_with_no_initial_guess_and_update(self):

        print("---testing sparse random strongly convex qp with equality and inequality constraints: test multiple solve after warm starting with previous results and no initial guess and update---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_cold_start_with_previous_result_starting_with_no_initial_guess_and_update(self):

        print("---testing sparse random strongly convex qp with equality and inequality constraints: test multiple solve after cold starting with previous results and no initial guess and update---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_warm_start_with_no_initial_guess_and_update(self):
        ...
        print("---testing sparse random strongly convex qp with equality and inequality constraints: test multiple solve from warm start and no initial guess and update---")
        n = 10
        H,g,A,b,C,u,l = generate_mixed_qp(n)
        n_eq = A.shape[0]
        n_in = C.shape[0]
    ...
    def test_case_update_A_for_different_initial_guess(self):
        ...
        assert(pri_res <= 1E-9)
        Qp.update(A = A)
        assert(normInf(Qp.model.A - A)<=1.e-9)
        Qp.solve()
        dua_res = normInf(H @ Qp.results.x + g + A.transpose() @ Qp.results.y + C.transpose() @ Qp.results.z) 
        pri_res = max( normInf(A @ Qp.results.x - b),
			normInf(np.maximum(C @ Qp.results.x - u,0) + np.minimum(C @ Qp.results.x - l,0)))
