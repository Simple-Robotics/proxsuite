...
void exposeSettings(pybind11::module_ m){
	::pybind11::class_<qp::Settings<T>>(m, "Settings")
			...
			.def_readwrite("refactor_dual_feasibility_threshold",&qp::Settings<T>::refactor_dual_feasibility_threshold)
			.def_readwrite("refactor_rho_threshold", &qp::Settings<T>::refactor_rho_threshold)
			...
			.def_readwrite("nb_iterative_refinement",&qp::Settings<T>::nb_iterative_refinement)
