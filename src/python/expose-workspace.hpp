...
void exposeWorkspace(pybind11::module_ m){
	::pybind11::class_<qp::dense::Workspace<T>>(m, "Workspace")
			...
			.def_readwrite("current_bijection_map",&qp::dense::Workspace<T>::current_bijection_map)
			.def_readwrite("new_bijection_map", &qp::dense::Workspace<T>::new_bijection_map)
			...
			.def_readwrite("active_inequalities",&qp::dense::Workspace<T>::active_inequalities)
			...
			.def_readwrite("primal_feasibility_rhs_1_eq",&qp::dense::Workspace<T>::primal_feasibility_rhs_1_eq)
			.def_readwrite("primal_feasibility_rhs_1_in_u",&qp::dense::Workspace<T>::primal_feasibility_rhs_1_in_u)
			.def_readwrite("primal_feasibility_rhs_1_in_l",&qp::dense::Workspace<T>::primal_feasibility_rhs_1_in_l)
			.def_readwrite("dual_feasibility_rhs_2",&qp::dense::Workspace<T>::dual_feasibility_rhs_2)
			.def_readwrite("correction_guess_rhs_g",&qp::dense::Workspace<T>::correction_guess_rhs_g)
			.def_readwrite("alpha", &qp::dense::Workspace<T>::alpha)
			.def_readwrite("dual_residual_scaled",&qp::dense::Workspace<T>::dual_residual_scaled)
			.def_readwrite("primal_residual_eq_scaled",&qp::dense::Workspace<T>::primal_residual_eq_scaled)
			.def_readwrite("primal_residual_in_scaled_up",&qp::dense::Workspace<T>::primal_residual_in_scaled_up)
			.def_readwrite("primal_residual_in_scaled_low",&qp::dense::Workspace<T>::primal_residual_in_scaled_low)
			.def_readwrite("primal_residual_in_scaled_up_plus_alphaCdx",&qp::dense::Workspace<T>::primal_residual_in_scaled_up_plus_alphaCdx)
			.def_readwrite("primal_residual_in_scaled_low_plus_alphaCdx",&qp::dense::Workspace<T>::primal_residual_in_scaled_low_plus_alphaCdx)
