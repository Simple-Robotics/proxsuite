...
exposeWorkspaceDense(pybind11::module_ m)
{
  ::pybind11::class_<Workspace<T>>(m, "Workspace")
    ...
    .def_readwrite("current_bijection_map",
                   &Workspace<T>::current_bijection_map)
    .def_readwrite("new_bijection_map", &Workspace<T>::new_bijection_map)
    .def_readwrite("active_set_up", &Workspace<T>::active_set_up)
    .def_readwrite("active_set_low", &Workspace<T>::active_set_low)
    .def_readwrite("active_inequalities", &Workspace<T>::active_inequalities)
    ...
    .def_readwrite("primal_feasibility_rhs_1_eq",
                   &Workspace<T>::primal_feasibility_rhs_1_eq)
    .def_readwrite("primal_feasibility_rhs_1_in_u",
                   &Workspace<T>::primal_feasibility_rhs_1_in_u)
    .def_readwrite("primal_feasibility_rhs_1_in_l",
                   &Workspace<T>::primal_feasibility_rhs_1_in_l)
    .def_readwrite("dual_feasibility_rhs_2",
                   &Workspace<T>::dual_feasibility_rhs_2)
    .def_readwrite("correction_guess_rhs_g",
                   &Workspace<T>::correction_guess_rhs_g)
    .def_readwrite("alpha", &Workspace<T>::alpha)
    .def_readwrite("dual_residual_scaled", &Workspace<T>::dual_residual_scaled)
    .def_readwrite("primal_residual_eq_scaled",
                   &Workspace<T>::primal_residual_eq_scaled)
    .def_readwrite("primal_residual_in_scaled_up",
                   &Workspace<T>::primal_residual_in_scaled_up)
    .def_readwrite("primal_residual_in_scaled_low",
                   &Workspace<T>::primal_residual_in_scaled_low)
    .def_readwrite("primal_residual_in_scaled_up_plus_alphaCdx",
                   &Workspace<T>::primal_residual_in_scaled_up_plus_alphaCdx)
    .def_readwrite("primal_residual_in_scaled_low_plus_alphaCdx",
