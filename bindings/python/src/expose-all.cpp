...
PYBIND11_MODULE(PYTHON_MODULE_NAME, m) {
  ...
  // Add helpers
  pybind11::module_ helpers_module = m.def_submodule("helpers", "Helper module");
  ...
  helpers_module.def("checkVersionAtLeast", helpers::checkVersionAtLeast,
                     pybind11::arg("major_version"),pybind11::arg("minor_version"),pybind11::arg("patch_version"),
                     "Check version of the package is at least greater than the one provided as input.");
